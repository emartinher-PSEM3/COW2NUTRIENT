...
def OSTARA_cost_module(fc_struvite, fc_P_PO4_feed):
    ...
    FBR_size_array = ['Pearl 500','Pearl 2K','Pearl 10K']
    ...
    FBR_cost = {'Pearl 500':2.3E6, 'Pearl 2K':3.06E6, 'Pearl 10K':10E6} #USD
    ...
    FBR_operating_cost_partial = 7.54*fc_P_PO4_feed_day*365
