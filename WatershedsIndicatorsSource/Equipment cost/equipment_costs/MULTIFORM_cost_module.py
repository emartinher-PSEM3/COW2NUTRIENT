...
def MULTIFORM_cost_module(fc_P_PO4_feed):
    ...
    # ####################################################
    # ====================================================
    #Unit cost(Multiform) includes all the system
    MULTIFORM_cost = 625000.0 #USD/unit
    MULTIFORM_dryer_cost = 420000 #USD/unit

    MULTIFORM_equipment_cost = MULTIFORM_cost*n_MULTIFORM + MULTIFORM_dryer_cost  #Total installation
    ...
    MULTIFORM_operating_cost_partial = MULTIFORM_OperatingCost*fc_P_PO4_feed_day*365
