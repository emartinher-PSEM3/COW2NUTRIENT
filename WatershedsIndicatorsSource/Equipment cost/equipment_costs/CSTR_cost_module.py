...
def CSTR_investment_cost (F_total, total_time, mixing_operation,feedstock_parameters):
    ...
    from cereslibrary.PTechs.equipment_costs.vessel_design_cost import vessel_design_cost
    from cereslibrary.PTechs.equipment_costs.agitator_design_cost import agitator_design_cost
